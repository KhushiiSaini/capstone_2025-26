        ...
        <div className="rounded-3xl shadow-md p-10 bg-white mx-auto w-full ">
          ...
          <div className="bg-[#F9E9F0] rounded-2xl p-6 mb-10 flex justify-between items-center ">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl font-semibold border transition ${unreadCount === 0
            ...
            <div className="flex bg-[#F9E9F0] border border-[#CA99B1] rounded-full p-1 space-x-1">
              {(["all", "unread"] as const).map((key) => (
                <button
                  ...
                  className={`px-4 py-1 rounded-full font-semibold text-sm transition ${filter === key ? "bg-[#7A003C] text-white" : "text-[#7A003C]"
                    }`}
                >
                  {key === "all" ? "All" : "Unread"}
                </button>
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((n) => (
                  <button
                    ...
                    className={`w-full text-left rounded-xl px-4 py-3 flex justify-between items-start transition ${selected?.id === n.id ? "bg-white" : "bg-[#FDF4F8]"
                      }`}
                  >
                    <div>
